...
public class FragmentCurrentTrip extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_currenttrip, container, false);
    ...
    private void getRouteValidation()
    {
        ...
        }catch (Exception e)
        {
            ...
            db.closeDB();
            cr.close();
            getTicketTransaction(trip);
        }
    }

    private String getTicketTransaction(String trip)
    {
        DatabaseHelper dbHelper = new DatabaseHelper(getActivity().getApplication());
        String val = "";
        try
        {
                Cursor cr = dbHelper.getPaxTicketTransCurrentTrip(dbHelper, trip);
                //Cursor cr1 = dbHelper.getTripRoute(dbHelper);
